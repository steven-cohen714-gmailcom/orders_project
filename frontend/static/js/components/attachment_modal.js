          ...
          deleteBtn.onclick = async (e) => {
            ...
            try {
              ...
              const endpoint = isRequisition
                ? `/requisitions/delete_attachment/${orderId}/${encodeURIComponent(f.filename)}`
                : `/orders/delete_attachment/${orderId}/${encodeURIComponent(f.filename)}`;
              ...
              msg.textContent = data.message || "✅ File deleted successfully";
              msg.style.color = "green";
              msg.style.marginTop = "0.5rem";
              modal.inner.appendChild(msg);
