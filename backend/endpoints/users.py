...
class UserCreate(BaseModel):
    ...
    can_receive_payment_notifications: Optional[int] = 0 # Added payment notifications flag
...
class UserUpdate(BaseModel):
    ...
    email: Optional[EmailStr] = None # Added email field
    can_receive_payment_notifications: Optional[int] = None # Added payment notifications flag
...
async def get_users():
    ...
    for u in users_data:
        ...
        result_users.append({
            ...
            "email": u["email"], # Include new email field
            "can_receive_payment_notifications": u["can_receive_payment_notifications"] # Include new flag
        })
    conn.close()
...
async def update_user(user_id: int, payload: UserUpdate, request: Request):
    ...
    try:
        ...
        fields_to_update = {
            ...
            "email": payload.email, # Include email in update fields
            "can_receive_payment_notifications": payload.can_receive_payment_notifications # Include payment notifications flag
        }
