# File: compare_local_to_sync.py
# This script compares the local project directory to the VM's sync folder.
...
def main():
    print(f"🔎 Comparing local project to VM's sync folder (DRY RUN)")
    cmd = [
        "rsync",
        "-az",
        "--dry-run",
    ...
    try:
        ...
        print("\n✅ Comparison complete. The above list shows the changes that a 'push' would make.")
